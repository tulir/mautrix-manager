// From https://github.com/rburns/ansi-to-html/blob/master/src/ansi_to_html.js
// Copyright (c) 2012 Rob Burns - MIT license
// Modified to remove unnecessary bloat like entities dependency
...
function generateOutput(stack, token, data, options) {
    ...
    if (token === "text") {
        result = options.escapeHTML ? escapeHTML(data) : data
...
class Filter {
     ...
     * @param {boolean=} options.escapeHTML Escape HTML.
