...
if (os.path.exists("../.git") or os.path.exists(".git")) and shutil.which("git"):
    try:
        ...
        git_revision_url = f"https://github.com/tulir/mautrix-manager/commit/{git_revision}"
...
git_tag_url = (f"https://github.com/tulir/mautrix-manager/releases/tag/{git_tag}"
